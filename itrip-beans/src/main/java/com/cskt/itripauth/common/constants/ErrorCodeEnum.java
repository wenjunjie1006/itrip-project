...
public enum ErrorCodeEnum {
    ...
    AUTH_TOKEN_IS_EMPTY("30007", "token为空"),
    AUTH_ILLEGAL_USERCODE("30008", "非法的用户名"),
    AUTH_NOT_ACTIVATE("30009", "用户未激活"),
    AUTH_LOGOUT_SUCCESS("30010", "退出成功"),
    AUTH_NOT_LOGIN("30011", "用户未登录"),
    AUTH_PARAMETER_IS_EMPTY("30012", "参数为空"),
